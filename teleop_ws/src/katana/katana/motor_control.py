...
MAX_PWM = 255  # Normal driving max PWM
...
# Control Parameters
ANGULAR_SCALE = 300.0     # Scale factor for steering while driving
SPOT_TURN_SCALE = 800.0    # Scale factor for spot turning
