...
class TeleopGUI(QMainWindow):
    def __init__(self):
        ...
        # Steering display (-0.5 to 0.5 rad/s)
        ...
        status_layout = QVBoxLayout()  # Changed to vertical to accommodate velocities
